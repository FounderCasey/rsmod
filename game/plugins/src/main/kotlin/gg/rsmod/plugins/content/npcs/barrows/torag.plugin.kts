...
npc_drop_table(Npcs.TORAG_THE_CORRUPTED) {
    val map = HashMap<Int, Int>()
    val drops = intArrayOf(Items.TORAGS_HELM, Items.TORAGS_HAMMERS, Items.TORAGS_PLATEBODY, Items.TORAGS_PLATELEGS, Items.AMULET_OF_THE_DAMNED)
